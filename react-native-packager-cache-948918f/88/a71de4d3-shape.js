...
if(!(r1>epsilon))context.moveTo(0,0);else
...
if((da0-=p0*2)>epsilon)p0*=cw?1:-1,a00+=p0,a10-=p0;else
da0=0,a00=a10=(a0+a1)/2;
if((da1-=p1*2)>epsilon)p1*=cw?1:-1,a01+=p1,a11-=p1;else
...
if(!(da1>epsilon))context.moveTo(x01,y01);else
...
if(!(r0>epsilon)||!(da0>epsilon))context.lineTo(x10,y10);else
...
if(defined0=!defined0)output.lineStart();else
output.lineEnd();
}
...
if(sortValues!=null)index.sort(function(i,j){return sortValues(arcs[i],arcs[j]);});else
if(sort!=null)index.sort(function(i,j){return sort(data[i],data[j]);});
...
lineEnd:function lineEnd(){
switch(this._point){
case 3:_point(this,this._x1,this._y1);
...
point:function point(x,y){
x=+x,y=+y;
if(this._point)this._context.lineTo(x,y);else
...
moveTo:function moveTo(x,y){this._context.moveTo(y,x);},
closePath:function closePath(){this._context.closePath();},
lineTo:function lineTo(x,y){this._context.lineTo(y,x);},
bezierCurveTo:function bezierCurveTo(x1,y1,x2,y2,x,y){this._context.bezierCurveTo(y1,x1,y2,x2,y,x);}};
